...
from PyQt5.QtWidgets import QFileDialog, QMainWindow, QApplication, QWidget, QPushButton, QAction, QLineEdit, \
...
class MainWindow(QMainWindow):
    ...
    def load_product_from_db(self):
        ...
        for i in range(0, self.product_amount_entry):
            ...
            self.product_list.setItem(i, 2,
                                      QtWidgets.QTableWidgetItem(str(self.product_list_db[i]["product_category"])))
            self.product_list.setItem(i, 3, QtWidgets.QTableWidgetItem(str(self.product_list_db[i]["product_brand"])))
            self.product_list.setItem(i, 4,
                                      QtWidgets.QTableWidgetItem(str(round(self.product_list_db[i]["product_price"]))))
